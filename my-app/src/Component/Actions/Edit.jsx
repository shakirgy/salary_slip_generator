...
//   //         `http://localhost:4000/getemployee/${_id}`
//   //       );
...
//             initialDetails.advance - initialDetails.pf - initialDetails.labourwelfarefund,
//           netpay:
...
//   setEmpdetails({
//     ...empdetails,
//     totaldeduction: isNaN(totalDeduction) ? empdetails.totaldeduction : totalDeduction,
//     netpay: isNaN(netpay) ? empdetails.netpay : netpay,
//     totalamount: isNaN(totalAmount) ? empdetails.totalamount : totalAmount,
//   });
// }, [empdetails.advance, empdetails.pf, empdetails.labourwelfarefund, empdetails.basicpay]);
...
function Edit() {
  ...
  }, [empdetails.pf,empdetails.advance,empdetails.basicpay,empdetails.labourwelfarefund]);
